...
package com.natanduarte.acheiestagio.controller;

import com.natanduarte.acheiestagio.actions.Action;
...
public class Controller extends HttpServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String className = "com.natanduarte.acheiestagio.actions."+action;
